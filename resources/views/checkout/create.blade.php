                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    {{-- jika auth occupation gagal, value awalnya old occpation --}}
                                ...
                                <div class="mb-4">
                                    ...
                                    {{-- jika auth phone gagal, value awalnya old phone --}}
                                    @if ($errors->has('phone'))
                                ...
                                <div class="mb-4">
                                    ...
                                    {{-- jika auth address gagal, value awalnya old address --}}
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="discount" type="text"
                                        ...
                                        value="{{ old('discount') }}">
                                    {{-- jika auth discount gagal, value awalnya old discount --}}
